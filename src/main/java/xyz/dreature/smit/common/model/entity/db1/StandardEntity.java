...
public class StandardEntity {
    ...
    // 全参构造器
    public StandardEntity(Long id, Integer numericValue, Double decimalValue, String textContent, Boolean activeFlag) {
        this.id = id;
    ...
    // 复制构造器
    public StandardEntity(StandardEntity standardEntity) {
        this.id = standardEntity.getId();
        this.numericValue = standardEntity.getNumericValue();
        this.decimalValue = standardEntity.getDecimalValue();
        this.textContent = standardEntity.getTextContent();
        this.activeFlag = standardEntity.getActiveFlag();
    }
