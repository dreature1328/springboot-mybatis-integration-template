...
public class MockExtractor implements Extractor<JsonNode> {
    ...
    // 模拟抽取
    @Override
    public List<JsonNode> extract(EtlContext context, Map<String, ?> mockParams) {
    ...
    // 模拟抽取
    @Override
    public List<JsonNode> extractBatch(EtlContext context, List<? extends Map<String, ?>> mocksParams) {
